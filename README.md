...
9|pages.js|모든 화면을 렌더 해주는 기능을 하는 라우터들의 모임이다.| 판매 책/무료나눔/구매 책/커뮤니티/판매내역/관심상품/작성글 목록/아이디찾기/비밀번호찾기/비밀번호변경/검색결과/고객문의 페이지 렌더링
10|search.js|카테고리 검색을 해주는 기능을 하는 라우터가 있다.| 게시물명/책 제목/책 저자명/출판사명/커뮤니티 제목/전체 카테고리 검색
11|searchLoggedIn.js|로그인을 
